...
export function App() {
  ...
  return <Routes><Route path="/preview" element={<DeveloperPreviewPage />} /><Route path="/login" element={user ? <Navigate to="/" replace /> : <LoginPage />} /><Route element={user ? <Layout user={user} /> : <Navigate to={loginPath} replace />}><Route path="/" element={<HomePage />} /><Route path="/activities" element={<ActivitiesPage />} /><Route path="/records" element={<RecordsPage />} /><Route path="/report" element={<ReportPage />} /><Route path="/goals" element={<GoalsPage />} /></Route><Route path="*" element={<Navigate to={user ? "/" : loginPath} replace />} /></Routes>;
}
